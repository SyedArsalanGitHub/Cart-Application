...
import 'package:dummyfluttercartapp/cart_model/cart_model.dart';
import 'package:dummyfluttercartapp/db_helper.dart';
                  ...
                  if(snapshot.hasData){
                    ...
                    if(snapshot.data!.isEmpty){
                      return Align( 
                        ...
                        child: Column(
                          children: [
                            Image.network("https://img.freepik.com/premium-vector/realistic-empty-shopping-cart-trolley-promotion-isolated-white-background_572288-793.jpg?w=2000"),
                            SizedBox(height: 20,),
